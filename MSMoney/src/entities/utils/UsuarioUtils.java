...
public class UsuarioUtils {
	...
	public List<List<Financa>> atualizarResumo(List<List<Financa>> listaResumo, List<Financa> listaRendimento,
			List<Financa> listaDespesas, List<Financa> listaLongoPrazo, List<Financa> listaDespesasOcasionais) {
